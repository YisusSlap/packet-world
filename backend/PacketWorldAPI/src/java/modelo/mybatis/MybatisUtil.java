    ...
    public static SqlSession getSession() {
        ...
        try {
            ...
            props.setProperty("db.url", System.getenv("DB_URL") != null ? System.getenv("DB_URL")
                    : "jdbc:mysql://localhost:3306/packet_world_db?serverTimezone=UTC");
            props.setProperty("db.username",
                    System.getenv("DB_USERNAME") != null ? System.getenv("DB_USERNAME") : "packet_user");
            props.setProperty("db.password",
                    System.getenv("DB_PASSWORD") != null ? System.getenv("DB_PASSWORD") : "Integracion2025");
